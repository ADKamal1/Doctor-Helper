...
class RegisterSelectGender extends StatefulWidget {
  ...
  const RegisterSelectGender({this.Id});
  @override
...
class _RegisterSelectGenderState extends State<RegisterSelectGender> {
  ...
  List<String> specialists = ['Heart', 'Stomak', 'Dentist'];
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    GenderSelection(
                      ...
                      femaleText: "Female",
                      linearGradient:
                          LinearGradient(colors: [mainColor, secondColor]),
                    ...
                    TheButton(
                      onTap: () {
                        ...
                        print("xxxxxxxxxxxxxxxxx" + widget.Id);
